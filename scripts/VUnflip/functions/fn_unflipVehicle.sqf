...
_forceParams = [ _forceParams, [1.2, 8] ] select ( _vehicle isKindOf "B_APC_Tracked_01_base_F" || { _vehicle isKindOf "MBT_01_base_F" } || { _vehicle isKindOf "Air" } );	//-- Panther OR Slammer
